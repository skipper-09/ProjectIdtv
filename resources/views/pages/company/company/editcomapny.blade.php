                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <select class="form-control select2 @error('user_id') is-invalid @enderror" name="user_id">
                                    ...
                                    @foreach ($owner as $k)
                                        <option value="{{ $k->id }}"
                                            {{ $k->id == $company->user_id ? ' selected' : '' }}>{{ $k->name }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('user_id')
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input type="text" name="owner_rek" value="{{ $company->owner_rek }}"
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input type="text" name="rekening" value="{{ $company->rekening }}"
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input type="number" name="fee_reseller" value="{{ $company->fee_reseller }}"
                            ...
                            <div class="form-group col-12 ">
                                ...
                                <textarea name="address" id="" cols="30" rows="10"
                                    class="form-control @error('address') is-invalid @enderror" data-height="80">{{ $company->address }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>

                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="text" value="{{ $user->username }}" name="username" class="form-control @error('username') is-invalid @enderror"
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <select class="form-control select2 @error('role') is-invalid @enderror" name="role">
                                ...
                                @foreach ($role as $s)
                                <option value="{{ $s->name }}" {{ $s->name == $user->roles[0]->name ? 'selected' :'' }}>{{ $s->name }} </option>
                                @endforeach
                            </select>
                            @error('role')
                            <div class="invalid-feedback">

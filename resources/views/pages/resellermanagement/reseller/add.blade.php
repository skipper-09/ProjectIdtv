...
<div class="main-content">
    <section class="section">
        ...
        <div class="card">
            <form action="{{ route('resellerdata.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" name="phone" inputmode="numeric" class="form-control @error('phone') is-invalid @enderror">
                            @error('phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" name="rekening" inputmode="numeric"

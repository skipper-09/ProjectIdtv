        ...
        <header>
            <div class="row justify-center align-items-center">
                <center class="align-self-center align-items-center" style="width: 100%">
                    <div class="btn-group btn-group-sm d-print-none"><a style="width: 120px;font-weight: bold"
                        ...
                        {{-- <a style="font-weight: bold;width: 120px;"
                            ...
                            Print</a> --}}
                            <a id="finish_btn" href="javascript:window.close()"
                            style="width: 120px;font-weight: bold" href=""
                ...
                <div class="col-sm-7 text-center text-sm-start mb-3 mb-sm-0"><img id="logo" style="max-width:150px;"
                        src="{{ asset('img/IDTV.png') }}"
                        title="topsetting" alt="topsetting" /></div>
                <div class="col-sm-5 text-center text-sm-end">
                    <h4 class="mb-0">INVOICE | <span style="font-style:italic;"><i class="fa fa-check"></i><span
                                style="color:green;">SUDAH BAYAR</span></span></h4>

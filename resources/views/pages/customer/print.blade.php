...
<div class="container-fluid invoice-container">
        ...
        <div class="row justify-center align-items-center">
            ...
            <div class="col-sm-5 text-center text-sm-end">
                <h4 class="mb-0">INVOICE |
                    @if ($subcription->payment->isEmpty() || $subcription->payment->where('status', '!=',
                    'paid')->isNotEmpty())
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-end">Rp. {{ number_format($subcription->paket->price +
                                    $customer->company->fee_reseller) }}</td>
                            </tr>
                ...
                <tbody>
                    <tr>
                        <td style=";padding: 3px" class="text-center">{{
                            \Carbon\Carbon::parse($subcription->end_date)->format('F j, Y')}}</td>
                        <td style=";padding: 3px" class="text-center">Manual</td>
                        <td style=";padding: 3px" class="text-center">{{ $subcription->invoices}}</td>
                        <td style=";padding: 3px" class="text-center">Rp. {{ number_format($subcription->paket->price +
                            $customer->company->fee_reseller) }}</td>
                    </tr>
                </tbody>
            </table>
    ...
    <div style="padding-left: 8px;" class="col-md-12"><span id="online_payment"><br>
            <ul style="margin-top: -10px">
                ...
                <li class="w-75">
                    Jika informasi pada bukti pembayaran ini ada kesalahan, silahkan hubungi kami<br><br><b>{{
                        $customer->company->name }}<br>
                        {{ $customer->company->address }}<br>

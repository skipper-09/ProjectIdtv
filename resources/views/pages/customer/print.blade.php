            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style=";padding: 3px" class="text-center">@if ($subcription->payment->isEmpty() ||
                            $subcription->payment->where('status', '!=', 'paid')->isNotEmpty())
                            <span style="color:red;">BELUM BAYAR</span>
                            @else{{ $subcription->payment[0]->payment_type }}
                            @endif
                        </td>

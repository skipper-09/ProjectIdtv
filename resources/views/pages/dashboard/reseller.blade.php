...
<script>
    $(document).ready(function () {
        ...
        var clipboard = @json($reseller->referal_code);

        var dataurl = url(`/register/pelanggan?kode=${clipboard}`);
        $('#salintext').click(function () {  
            navigator.clipboard.writeText(dataurl).then(function () {
        
                swal({
                    title: "Success!",
                    text: "Link Pendaftaran Customer Berhasil disalin!",
                    icon: "success",
                });
            }).catch(function (err) {
